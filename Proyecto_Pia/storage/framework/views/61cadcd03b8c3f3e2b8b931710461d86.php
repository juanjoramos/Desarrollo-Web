...
<body class="font-sans antialiased bg-[#1f2937] text-white">
    <div class="bg-[#1f2937] text-white text-opacity-50 dark:text-white/50">
            <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="https://laravel.com/assets/img/welcome/background.svg" alt="Laravel background" />
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="952" height="120" viewBox="0 0 912 273">
                            <text x="456" y="136" fill="#ffffff" font-family: "'Figtree', sans-serif" font-size="80" text-anchor="middle" dominant-baseline="middle">
                                Proyecto PIA - Equipo F
                            </text>
                            </svg>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-sm text-center">
                        ...
                        <div>
                            ...
                            <p class="pb-2">
                            <a href="https://github.com/juanjoramos" target="_blank" rel="noopener noreferrer">Juan José Ramos</a>
                            </p>
                            <p class="pb-2">
...
<?php /**PATH C:\clase_aut\resources\views/welcome.blade.php ENDPATH**/ ?>