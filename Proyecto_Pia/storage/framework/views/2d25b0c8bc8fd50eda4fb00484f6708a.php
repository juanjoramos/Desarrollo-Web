...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <select name="id_tipo_proyecto" class="w-full border p-2 rounded" required>
                    ...
                    <?php $__currentLoopData = $tiposProyecto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tipo->id); ?>"><?php echo e($tipo->descripcion); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php $__errorArgs = ['id_tipo_proyecto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(route('proyectos.index')); ?>" class="ml-4 text-gray-700">Cancelar</a>
        </form>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\clase_aut\resources\views/proyectos/create.blade.php ENDPATH**/ ?>